...
insert into users values('admin', 'e739279cb28cdafd7373618313803524', 1, '2016-09-15', 1, 'email', '888888', 1, '2016-08-08 00:00:00', 'admin');
...
create table if not exists bi_database(
 	id integer GENERATED BY DEFAULT AS IDENTITY(START WITH 1),
...
create table if not exists bi_database_source(
 	id integer GENERATED BY DEFAULT AS IDENTITY(START WITH 1),
...
create table if not exists database_chart(
	id integer GENERATED BY DEFAULT AS IDENTITY(START WITH 1),
...
create table if not exists restful_chart(
	id integer GENERATED BY DEFAULT AS IDENTITY(START WITH 1),
	chart_name varchar(40),
	chart_type varchar(10),
	chart_option clob,
